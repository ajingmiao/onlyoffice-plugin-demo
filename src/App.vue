<template>
  <div style="height:100vh;display:flex;flex-direction:column;">
    <header style="padding:8px;border-bottom:1px solid #eee;display:flex;gap:8px;align-items:center;">
      ...
      <button @click="highlight" style="background:#ffc107;color:#000;border:none;padding:6px 12px;border-radius:4px;">高亮关键词</button>
      <button @click="replace" style="background:#28a745;color:#fff;border:none;padding:6px 12px;border-radius:4px;">搜索替换</button>
...
const PLUGIN_CONF = DOCUMENT_SERVER + '/9.0.4-9ade76efaf7465c8db6be392804370a8/sdkjs-plugins/demo-a/config.json'
...
function highlight() {
  serviceCommandSafe('highlight', { text: 'ONLYOFFICE', color: '#FFFF00' })
}
function replace() {
  serviceCommandSafe('replace', { from: '测试', to: '替换成功' })
}
